    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            try {
                ...
                //Converting to mp3
                console.log("Converting: " + name_1.name + name_1.ext + " -> " + dest + ".mp3");
                child_process_1.execSync("ffmpeg -i " + file + " " + dest + ".mp3", {
                    stdio: "pipe"
                });
                //Converting to mp4
                console.log("Converting: " + name_1.name + name_1.ext + " -> " + dest + ".mp4");
